            ...
            if ($get_user > 0) {
                ...
                if ($run) {
                    ...
                    set_msg('<div class="alert alert-success text-center">
                      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                      <strong>Success! Mr ' . $cl_name .'</strong>. Registration was successfull and
                    Email has been sent to you on email address <strong>"' . $cl_email . '"</strong>"
                  </div>');

                    send_email($cl_email, $cl_name);
                } else {
